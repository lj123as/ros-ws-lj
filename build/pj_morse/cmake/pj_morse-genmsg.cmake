...
message(STATUS "pj_morse: 1 messages, 1 services")
...
get_filename_component(_filename "/home/lj/catkin_ws/src/pj_morse/srv/greeting.srv" NAME_WE)
add_custom_target(_pj_morse_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pj_morse" "/home/lj/catkin_ws/src/pj_morse/srv/greeting.srv" ""
)
...
### Generating Services
_generate_srv_cpp(pj_morse
  "/home/lj/catkin_ws/src/pj_morse/srv/greeting.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/pj_morse
)
