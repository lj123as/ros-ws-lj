...
(cl:defmethod cl:initialize-instance :after ((m <greeting-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'greeting-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pj_morse-srv:<greeting-request> is deprecated: use pj_morse-srv:greeting-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <greeting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pj_morse-srv:name-val is deprecated.  Use pj_morse-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <greeting-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pj_morse-srv:age-val is deprecated.  Use pj_morse-srv:age instead.")
  (age m))
...
(cl:defmethod cl:initialize-instance :after ((m <greeting-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'greeting-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pj_morse-srv:<greeting-response> is deprecated: use pj_morse-srv:greeting-response instead.")))

(cl:ensure-generic-function 'feedback-val :lambda-list '(m))
(cl:defmethod feedback-val ((m <greeting-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pj_morse-srv:feedback-val is deprecated.  Use pj_morse-srv:feedback instead.")
  (feedback m))
